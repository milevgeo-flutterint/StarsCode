...
local colors = {
	...
	stars_white_alt = "#f1f1f1",
	stars_white_alt_dark = "#e6e6e6",
...
function M.setup()
	...
	local editor = {
		...
		Search = { fg = colors.stars_black, bg = colors.stars_white_alt },
		IncSearch = { fg = colors.stars_black, bg = colors.stars_white_alt_dark },
	...
	local syntax = {
		...
		Boolean = { fg = colors.stars_white_alt_dark, bold = true },
		...
		Label = { fg = colors.stars_white_alt },
		...
		Special = { fg = colors.stars_white_alt },
		SpecialChar = { fg = colors.stars_white_alt_dark },
		...
		Todo = { fg = colors.stars_black, bg = colors.stars_white_alt, bold = true },
	}
	...
	local git = {
		...
		DiffText = { fg = colors.stars_white_alt, bg = colors.stars_black_grey },
	...
	local treesitter = {
		TSAnnotation = { fg = colors.stars_white_alt },
		TSAttribute = { fg = colors.stars_blue },
		TSBoolean = { fg = colors.stars_white_alt_dark, bold = true },
		...
		TSLabel = { fg = colors.stars_white_alt },
		...
		TSSymbol = { fg = colors.stars_white_alt },
		...
		TSMath = { fg = colors.stars_white_alt_dark },
		TSTextReference = { fg = colors.stars_white_alt },
		...
		TSWarning = { fg = colors.stars_white_alt_dark, bg = colors.stars_black_grey, bold = true },
